...
#define STRING_CONFIG_H_AUTHOR "(Porkchop)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -55.0, -15.0, -3.5 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 115, 75, 60, 60 } // (mm) Left, Front, Right, Back insets
